...
faqs:
  - q: "Is cannabis decriminalized in Portugal for tourists?"
    a: "Yes. Portugal decriminalized personal possession and use of all drugs in 2001 (Law 30/2000). For cannabis, the personal-use threshold is 2.5g of flower or 0.5g of hash. Tourists are covered by the same law — possession within these limits is not a criminal offense, though you may be referred to the Drug Dissuasion Commission (CDT)."
  - q: "What happens if police find cannabis on a tourist in Portugal?"
    a: "If the quantity is within the personal-use limit (2.5g flower), you will not be arrested. Police will identify you and refer your case to the local Drug Dissuasion Commission (CDT), an administrative body. The CDT may impose a symbolic fine, community service, or voluntary treatment referral. There is no criminal record. For tourists, it is an unpleasant bureaucratic experience but not a criminal one."
  - q: "What is the Drug Dissuasion Commission (CDT) in Portugal?"
    a: "The CDT (Comissão para a Dissuasão da Toxicodependência) is a civil administrative panel, not a court. When police find someone with drugs for personal use, they refer the case to the CDT instead of charging them criminally. The CDT assesses whether the person is an occasional user or dependent and applies non-criminal measures. This system, created by Law 30/2000, is why Portugal's drug policy is considered a global model for harm reduction."
  - q: "Can I buy cannabis legally in Portugal?"
    a: "No. Portugal has no recreational cannabis stores or dispensaries. The 2001 decriminalization removed criminal penalties for users but did not create any legal purchase channel. Medical cannabis has been available since 2019 but requires a Portuguese doctor's prescription — inaccessible to tourists. The informal market exists in cities like Lisbon and Porto, but without quality guarantees or legal protection."
  - q: "Portugal drug policy — decriminalization vs legalization: what is the difference?"
    a: "Decriminalization (Portugal's model) removes criminal penalties for personal use and possession — users are not arrested or jailed, but the drug remains technically illegal. Legalization (Canada, Uruguay, Germany) goes further: it creates a regulated market for production, sale, and consumption. In Portugal, using cannabis is not a crime, but buying and selling it is. This means tourists may possess cannabis without being criminalized, but have no legal way to purchase it."
---
